...
if(($_SESSION['login_user']=="")) 
    ...
    $sql = "UPDATE gallery SET name='$name', title='$title', detail='$detail', file='$file',status='$status',date='$date' WHERE id = $id";
          ...
          <section class="wrapper">
				...
				<div class="col-lg-6">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-image"></i>Edit Photo</li>
                          ...
                          <div class="panel-body">
                              <form role="form" action="<?PHP echo $_SERVER['PHP_SELF'];?>" method="POST">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" value="<?php echo $row['name'];?>" name="name" placeholder="Enter Image Name..." >
                                  </div>
                                  <div class="form-group">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <p><a href="change_img.php?pid=<?php echo $row['id'];?>">Change Image</p>
