...
$date=$_POST['date'];
  ...
  $sql = "INSERT INTO news (heading, title, detail, file, status, date) VALUES ('".$heading."','".$title."','".$detail."','".$file."', '".$status."', '".$date."' )";
          ...
          <section class="wrapper">
				...
				<div class="col-lg-6">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-file"></i>Add News</li>
                          ...
                          <div class="panel-body">
                              <form role="form" enctype="multipart/form-data" action="<?PHP echo $_SERVER['PHP_SELF']; ?> " method="post">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" name="heading" placeholder="Enter News Heading..." required>
                                  </div>
