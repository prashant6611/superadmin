...
$sql= "INSERT INTO video(name,title,file,status,date) VALUES ('".$name."','".$title."','".$code."','".$status."','".$date."' )";
          ...
          <section class="wrapper">
				...
				<div class="col-lg-6">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-camera"></i>Add Video</li>
                          ...
                          <div class="panel-body">
                              <form role="form" action="<?PHP echo $_SERVER['PHP_SELF']; ?>" method="POST">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <textarea class="form-control" id="code" name="code" placeholder="Enter Video Code..." required></textarea>
                                  </div>
                                  <div class="form-group">
                                  ...
                                  <button type="submit" id="submit" name="video_submit" class="btn btn-primary">Submit</button>
                              </form>
