...
{  if(($_FILES["file"]["size"] >= "1024") ){
  ...
  $sql = "INSERT INTO testimonial (name, company, detail, file, status, date) VALUES ('".$name."','".$company."','".$detail."','".$file."','".$status."','".$date."' )";
          ...
          <section class="wrapper">
				...
				<div class="col-lg-6">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-quote-left"></i>Add Testimonial</li>
                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <form role="form" enctype="multipart/form-data" action="<?PHP echo $_SERVER['PHP_SELF']; ?> " method="post">
                                  ...
                                  <div class="form-group">
                                      <label for="exampleInputtitle">Organisation Name</label>
                                      <input type="text" class="form-control" name="company" placeholder="Enter Organisation Name..." required>
                                  </div>
                                  <div class="form-group">
                                      <label for="exampleInputdescription">Details</label>
                                      <textarea class="form-control ckeditor" name="detail" rows="6" required></textarea>
                                  </div>
                                  <div class="form-group">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <p class="help-block">Photo size:- 130x130 px</p>
