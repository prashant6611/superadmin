...
<table class="table table-striped table-advance table-hover">
     ...
     while($row = mysqli_fetch_array($rs_result)) {?>
                              <tr>
                                 ...
                                 <td>
                                  <div class="btn-group">
                                      <a class="btn btn-primary" href="edit_gallery.php?id=<?php echo $row['id']; ?>"><i class="icon_pencil-edit"></i></a>
                                      <a class="btn btn-danger" href="delete_img.php?id=<?php echo $row['id']; ?>"><i class="icon_close_alt2"></i></a>
                                  </div>
                                  </td>
                              </tr>
